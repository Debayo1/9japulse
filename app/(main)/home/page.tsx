...
import { Smartphone, World, CloudLightning, Airplay, Book, CoinStack, Certificate, ShoppingBag, Rocket, Award } from "@duo-icons/react";
...
const SERVICES = [
  ...
  { label: "Transfer",  Icon: Rocket,     href: "/transfer",   color: "#8B5CF6" },
  { label: "Gift Code", Icon: Award,      href: "/gift-codes", color: "#F59E0B" },
] as const;
...
export default function HomePage() {
  ...
  const performBackgroundSync = useCallback(async (isManual = false) => {
    setSyncing(true);
    setSyncMessage(isManual ? "Updating..." : "Syncing...");
    try {
          ...
          <div style={{
            ...
            <div
              ...
              style={{
                ...
                height: 6,
                borderRadius: "50%",
                backgroundColor: syncMessage === "Synced" || syncMessage === "Updated" ? "var(--color-success)" : syncMessage === "Sync failed" ? "var(--color-danger)" : "var(--color-warning)"
              }}
            />
            {syncMessage}
          </div>
